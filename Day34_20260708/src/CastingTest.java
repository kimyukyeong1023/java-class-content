...
// // 내가 만든 프로그램으로 계산을 하면 규칙에의해서
// // 정수만 출력된다. 
//
// // 내가 계산한 정수를 실수로 변경해야될 때가 
// // 있다. 그게 바로 casting(형변환)
//
...
// 그래서 큰 타입으로 자동으로 변경해서 계산한다.
		...
		/*
		 * 입출력 예 설명 입출력 예 #1 num1이 3, num2가 2이므로 3 / 2 = 1.5에 1,000을 곱하면 1500이 됩니다.
		 */
		int num1 = 3, num3 = 2;

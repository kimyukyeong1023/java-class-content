...
// private은 객체를 생성할 때 자물쇠가 
// 열려있다. 객체를 생성할때 자동으로 값을 저장하는
// 매개변수 받는 생성자가 필요한거다!
// 게임 캐릭터 생성해서 게임을 들어가면 자동으로 
// 레벨1 목숨 150 알아서 세팅?
...
// private은 객체를 생성할 때 자물쇠가 열려있다.

		은행계좌 민수계좌 = new 은행계좌(1000000);

// 1. new 은행계좌(1000000)
//    메모리공간 확보하고 그 안에 잔액변수를
//    만든다.
// 2. 은행계좌 생성자 자동 실행한다.
// 3. 잔액을 저장하고 private 설정된다.
// 4. 생성자가 종료가 된다.
// 5. 만들어진 변수의 공간을 민수 계좌에 저장한다.
// 6. 메인으로 돌아오면 main은 접근이 불가능하다.
...
// System.out.println(에리나계좌.balance);

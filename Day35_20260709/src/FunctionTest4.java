...
/*
 * // ArrayList로 여러명을 저장하는 배열 만들면 되자나요! // 단점 각각의 사람들이 이름이 어떤 공간에 저장되었는지 내가 //
 * 알고 있어야된다. // String 문자만 저장을 하니깐 계좌번호를 저장하는 배열을 또 만들어야된다. static
 * ArrayList<String> 사람들계좌이름 = new ArrayList<>(); static ArrayList<String> 사람들계좌
 * = new ArrayList<>(); static ArrayList<String> 사람들비밀번호 = new ArrayList<>();
 * static ArrayList<String> 사람들핸드폰번호 = new ArrayList<>();
 * 
 * 
 * static int 서희잔액 = 100000; static int 철수잔액 = 0;
 * 
 * 
 * public static void 출금(int 인출금액,String 계좌주인) { if(계좌주인.equals("서희")) { 서희잔액 -=
 * 인출금액; }else if(계좌주인.equals("철수")) { 철수잔액 -= 인출금액; } 사람이 증가할수록 if문 계속 늘어난다.
 * ArrayList 관리가 복잡하다! }
 * 
 * public static void 입금(int 입금금액,String 계좌주인) { 서희잔액 += 입금금액; } public static
 * void 계좌이체(int 계좌이체금액,String 상대방계좌번호,String 계좌주인) { // 상대방은 금액이 플러스! // 나는 잔액에
 * 마이너스! }
 * 
 * public static 음료 커피만들기(String 메뉴) { System.out.println("원두 2샷");
 * System.out.println("물받기"); System.out.println("섞는다"); return 메뉴; } public
 * static 찌개 식당이모님(String 메뉴) { System.out.println("김치를 자르고");
 * System.out.println("김치를 볶고"); System.out.println("물넣고");
 * System.out.println("10분간 끓인다."); return 메뉴;
 * 
 * }
 * 
 */
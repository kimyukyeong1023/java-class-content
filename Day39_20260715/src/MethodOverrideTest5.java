...
class 프랜차이즈본사 {
	void 매장운영방법() {
		System.out.println("본사 오전9시부터 오후9시까지 메뉴얼대로 운영합니다.");
	}
}

// 서울지점은 본사 운영방식을 그대로 사용한다.
class 서울강남점 extends 프랜차이즈본사 {
// 본사 메뉴얼 그대로 사용할꺼면 오버라이딩 안해도된다.
}

// 제주공함점 운영방식이 24시간 운영한다.
class 제주공함점 extends 프랜차이즈본사 {
// 본사 메뉴얼 그대로 사용할꺼면 오버라이딩 안해도된다.
	@Override
	void 매장운영방법() {

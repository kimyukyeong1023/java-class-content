...
// 문제점은 군인이든 전투기든 탱크든
// 모든 체력이 똑같다라는 점!
// 메인이 야! 이거는 이상하잖아! 그래서 고칠려고 
// 캐릭터라는 클래스가 체력을 안보이게 숨겼거든요!
...
// 게임 캐릭터를 만드는데 캐릭터 클래스 말고 main애가 
// 캐릭터 체력을 변경하면 될까요? 안될까요?
// 캐릭터 전사생성 = new 캐릭터();
// System.out.println("전사의 목숨:" + 전사생성.체력);
//
